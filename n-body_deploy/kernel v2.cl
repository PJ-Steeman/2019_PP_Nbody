...
//berekenen van de snelheid OPGELET : race condition
//meerdere threads willen schrijven naar dezelfde plaats
__kernel void snelheid(__global float3 *gpu_pos, __global float3 *gpu_speed)
{
